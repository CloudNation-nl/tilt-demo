...
Unfortunately there's one big downside on the image buildsteps for Docker, namely the lack of defining the target build stage. To achieve the same functionality, we now need to split up buildstages into different Dockerfiles. 
